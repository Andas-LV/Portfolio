...
export const About = () => {
    return (
        <div className={styles.container}>
            <p>
                I am an software engineer, i love programming very much, and i am currently engaged in front-end development.
            ...
            <p>
                ...
                My skills include front-end development technologies such as JavaScript, React, Vue and Flutter,
